...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      { name: "Product", path: "/dashboard/product", pro: false },
      { name: "Category", path: "/dashboard/category", pro: false },
      { name: "Brand", path: "/dashboard/brand", pro: false }
    ]
  },
  {
    icon: <UserIcon />,
        ...
        <li key={nav.name}>
          {nav.subItems ? (
            ...
            nav.path && (
              <Link
                to={nav.path}
                className={`menu-item group ${isActive(nav.path || "/dashboard/add-product") ? "menu-item-active" : "menu-item-inactive"
                  }`}
              >
                <span
